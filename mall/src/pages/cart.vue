<template>
      ...
      <div class="wrapper">
          <div class="container">
              <div class="cart-box">
                  ...
                  <ul class="cart-item-list" v-for="(item,index) in list" :key="index">
                      <li class="cart-item">
                          ...
                          <div class="item-del"  @click="delProduct(item)">
              ...
              <div class="order-wrap clearfix">
                  ...
                  <div class="total fr">
                      合计:<span>{{cartToatalPrice}}</span>元
  ...
  <modal title="提示" sureText="确定" btnType="0" modalType="middle" :showModal="showModal"   @cancel="showModal=false">
...
export default {
    ...
    methods:{
        ...
        renderData(res){
                ...
                this.cartToatalPrice=res.cartTotalPrice;
