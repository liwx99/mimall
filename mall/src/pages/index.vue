                ...
                <div class="nav-menu">
                    <ul class="menu-wrap">
                        <li class="menu-item">
                          ...
                          <li class="menu-item">
                            <a href="javascrpt:;">电视盒子</a>
                        </li>
                          <li class="menu-item">
                            <a href="javascrpt:;">笔记本电脑</a>
                        </li>
                          <li class="menu-item">
                            <a href="javascrpt:;">家电插线板</a>
                        </li>
                          <li class="menu-item">
                            <a href="javascrpt:;">出行穿戴</a>
                        </li>
                          <li class="menu-item">
                            <a href="javascrpt:;">智能路由器</a>
                        </li>
                         <li class="menu-item">
                            <a href="javascrpt:;">电源配件</a>
                        </li>
                         <li class="menu-item">
                            <a href="javascrpt:;">生活箱包</a>
                        </li>
                    </ul>
                </div>
...
export default {
    ...
    methods:{
        init(){
           /*/
            let url="http://mall-pre.springboot.cn/products?categoryId="+"100012&pageSize=14";
